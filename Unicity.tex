...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{img/mempool.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{img/FullStack3.png}
...
\begin{table}[ht]
    ...
    \begin{tabular}{@{}lllllll@{}}
        ...
        \addlinespace
        Consensus: BFT & \makecell[l]{Fast, deterministic\\finality} & PoW & 100 B/day & $\approx21\times$ & \makecell[l]{Uniq. Oracle's\\consistency proofs} \\
        \addlinespace
        Uniqueness Oracle & \makecell[l]{Recording token\\state transitions} & BFT & 50 B/tx & Few replicas & Proof generation \\
        \addlinespace
        Token Operations & User transactions & \makecell[l]{Uniq. Oracle\\and Recipients} & Own tokens & Recipients & \makecell[l]{Relevant\\transactions} \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{img/Miners.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{img/SMT-Infra2.png}
...
\begin{figure}[htbp]
    \centering
    \vspace{\baselineskip}
    \includegraphics[width=0.7\textwidth]{img/SMT-ProverMarketPlace.png}
...
\begin{figure}[htbp]
    \centering
    \vspace{\baselineskip}
    \includegraphics[width=0.5\textwidth]{img/Genesis.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.55\textwidth]{img/Transaction1.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{img/Transaction2.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{img/Orchestrator.png}
...
\begin{table}[h]
    ...
    \begin{tabular}{p{3cm}p{4.5cm}p{3cm}p{3cm}}
        ...
        \addlinespace
        Validator \nobreak{committee} & Committee attests to correct execution & Honest majority & Coordination \nobreak{overhead} \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{img/ConflictResolution.png}
...
\begin{table}[h]
    ...
    \begin{tabular}{p{2cm}p{3.5cm}p{4.5cm}p{4.5cm}}
        ...
        \addlinespace
        Intent \nobreak{Protocols}  & Ethereum-centric, solver centralization & Solvers see full order details; solver can extract value; settlement visible on-chain & Cross-chain native; no solver sees plaintext; truly decentralized matching; private settlement \\
        \addlinespace
        ...
        \addlinespace
        P2P \nobreak{Platforms} & Slow, scam risk, KYC in most jurisdictions & Platform sees all listings; KYC required; chat logs retained; bank trail & Trustless escrow; no platform visibility; no KYC \\
        \bottomrule
    \end{tabular}
\end{table}
